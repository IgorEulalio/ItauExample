...
* The original package name 'com.example.itau.Projeto Itau para apresentação da esteira de testes.' is invalid and this project uses 'com.example.itau.Projeto.Itau.para.apresenta.o.da.esteira.de.testes' instead.
